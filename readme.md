...
This is the repository for the Memrizr memorization application tutorial which is a work in progress. A containerized full-stack authentication and profile management system. Includes user registra
tion/login with JWT, profile image upload,and service-to-service communication using Docker Compose with Traefik proxy.
